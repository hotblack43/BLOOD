pro histo,tab1,mini,maxi,bin,abs=abs,cumul=cumul,zeroline=zeroline,overplot=overplot,$
...
;           /zeroline --> plot a vertical line at 0.0
;           title     --> title of plot
...
endelse
if (keyword_set(zeroline) eq 1) then begin
plots,[0,0],[!Y.CRANGE]
endif
return
end
